...
app.post('/players/', async (request, response) => {
  ...
  const addPlayer = `INSERT INTO cricket_team(player_name, jersey_number, role) VALUES(
...
app.get('/players/:playerId/', async (request, response) => {
  ...
  const playerDetails = `SELECT * FROM cricket_team; WHERE player_id = ${playerId};`
...
app.put('/players/:playerId/', async (request, response) => {
  ...
  const updateDetails = `UPDATE cricket_team SET player_name="${playerName}", jersey_number=${jerseyNumber}, role="${role}" WHERE player_id=${playerId};`
